...
The liquidity product direct sale is used in cases where sales are made to a third-party.
...
When a product sells is sold to a third party that will then sell the same product, a sales journal
is needed to register the invoice. This journal will not be synced with AFIP as the invoice will not
be electronic.
...
- :guilabel:`Use Documents`: check this field for the journal to be able to select the electronic
  document type (in this case the electronic invoice).
